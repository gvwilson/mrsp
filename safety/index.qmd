...
Research adds specific reasons people stay silent
beyond the ordinary fear of looking bad:

Fear of being scooped
:   Admitting that a method isn't working can feel like revealing a
    weakness that a competing lab will exploit.

Fear that asking questions signals you can't do the science
:   In a culture where everyone is expected to already know, asking is
    read as incompetence.

Fear of challenging the PI
:   The person who controls funding, authorship, and your reference
    letter is not someone most people feel safe contradicting.

These aren't paranoia:
they reflect real power differences,
and a manager who dismisses them as over-sensitivity
will never hear about the problems that matter.
...
{{< exercise _diagnose_team.qmd >}}

{{< exercise _practice_responding.qmd >}}
