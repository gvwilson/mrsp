...
-   Where to obtain the data the software operates on,
    and the terms under which it can be used
-   How to reproduce the computing environment
-   How to cite the project
    (the `CITATION.cff` file and the DOI to use in papers)
...
newcomers ease into a {{<g community-of-practice "community of practice" >}}
by starting with small, low-risk tasks
...
{{< exercise _contributing.qmd >}}

{{< exercise _fresh_eyes.qmd >}}
