...
These days,
preprint servers like [arXiv](@arxiv) are usually their first stop,
so a preprint or software paper is marketing that reaches the right audience by default.
...
The signal that matters most for research software
is being mentioned or cited in papers.
Track these through preprint servers and citation indexes,
and check them at the start or end of each month.
Downloads and GitHub stars are secondary
(stars measure curiosity, not use),
so don't mistake them for adoption.
...
{{< exercise _three_pitches.qmd >}}

{{< exercise _one_more_pitch.qmd >}}

{{< exercise _objections.qmd >}}
