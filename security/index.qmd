...
:   Removing names and identifiers from health data does not make it anonymous:
    dates of service, rare diagnoses, and postal codes can be combined
    to re-identify individuals.
    Treat "de-identified" data as sensitive unless an expert has confirmed otherwise.
