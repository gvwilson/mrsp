...
In reality, most of them are a compliance exercise:
...
The [next lesson](../hirefire/index.qmd) describes how to do this.
...
-   Negative:
    Plans generated or curated by LLMs have a specific failure mode:
...
{{< exercise _three_people.qmd >}}

{{< exercise _role_play.qmd >}}
